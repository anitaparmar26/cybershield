    ...
    <main className="relative bg-background text-foreground overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-20">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          ...
          {/* Mission Statement */}
          <div className="bg-card/50 border-2 border-primary/30 rounded-2xl p-12 mb-20 neon-glow-cyan">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-20">
            {stats.map((stat, idx) => (
              <div key={idx} className="bg-card/50 border-2 border-accent/30 rounded-xl p-8 text-center neon-glow-cyan hover:border-accent transition-colors">
                <div className="text-4xl font-bold text-accent mb-2">{stat.value}</div>
                <div className="text-sm font-medium text-muted-foreground uppercase">{stat.label}</div>
              </div>
            ))}
          </div>

          {/* Values Section */}
          <h2 className="text-4xl font-bold text-center mb-12 neon-text-glow">OUR VALUES</h2>
              ...
              return (
                <div key={idx} className="bg-card/50 border-2 border-primary/30 rounded-xl p-8 hover:border-accent transition-colors">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary to-accent flex items-center justify-center neon-glow-cyan flex-shrink-0">
